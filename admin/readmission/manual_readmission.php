...
// $sql1="select c_code,name_of_college_with_address from college_details where c_code not in (0001,0002,0003,0004,0005,1013,1014,1015,1026)";
...
function validation()
{
  if($("#college_name").val()=="" || $("#college_name").val()==null)
  {
    $("#myModal").css("display","block");
    $(".modal-content").css("background-color","#ff6666");
    $("#message").text("Enter College Name");
      return false;
  }
...
$("#discontinued_sem").change(function() {
      ...
      $("#uploadBtn").click(function() {
        ...
        if (files) {
          ...
          formData.append('c_code', $("#college_name").val());
          ...
          <!-- <div class="form-group">
            <div class="col-sm-10">
              <label for="fg" class="control-label"
                >Whether First graduate amount claimed for 2019-2020</label
              >
            </div>
            <div class="col-sm-6">
          ...
          <!-- <div class="form-group">
            <div class="col-sm-10">
              <label for="pms" class="control-label"
                >Whether Post Matric Scholarship claimed for 2019-2020</label
              >
            </div>
            <div class="col-sm-6">
...
<option value="COMPUTER SCIENCE AND ENGINEERING (INTERNET OF THINGS AND CYBER SECURITY INCLUDING BLOCK CHAIN TECHNOLOGY)">COMPUTER SCIENCE AND ENGINEERING (INTE</option>RNET OF THINGS AND CYBER SECURITY INCLUDING BLOCK CHAIN TECHNOLOGY)
...
<option value="MASTER OF BUSINESS ADMINISTRATION (PART TIME)"> MASTER OF BUSINESS ADMINISTRATION (PART TIME)</option>
<option value="MASTER OF BUSINESS ADMINISTRATION(INTEGRATED)"> MASTER OF BUSINESS ADMINISTRATION(INTEGRATED)</option>
<option value="MBA(INNOVATION ENTREPRENEURSHIP AND VENTURE DEVELOPMENT)"> MBA(INNOVATION ENTREPRENEURSHIP AND VENTURE DEVELOPMENT)</option>
<option value="MBA(WASTE MANAGEMENT AND SOCIAL ENTREPRENEURSHIP) ">MBA(WASTE MANAGEMENT AND SOCIAL ENTREPRENEURSHIP)</option>
...
<option value="APPLIED ELECTRONICS (PART TIME)"> APPLIED ELECTRONICS (PART TIME)</option>
<option value="AUTOMOBILE ENGINEERING ">AUTOMOBILE ENGINEERING</option>
<option value="AUTOMOTIVE ENGINEERING"> AUTOMOTIVE ENGINEERING</option>
<option value="AVIONICS ">AVIONICS</option>
<option value="BIG DATA ANALYTICS ">BIG DATA ANALYTICS</option>
<option value="BIOMEDICAL ENGINEERING"> BIOMEDICAL ENGINEERING</option>
<option value="BIOMETRICS & CYBER SECURITY"> BIOMETRICS & CYBER SECURITY</option>
...
<option value="COMPUTER SCIENCE AND ENGINEERING ">COMPUTER SCIENCE AND ENGINEERING</option>
<option value="COMPUTER SCIENCE AND ENGINEERING(WITH SPECIALIZATION IN NETWORKS)"> COMPUTER SCIENCE AND ENGINEERING(WITH SPECIALIZATION IN NETWORKS)</option>
...
<option value="ELECTRICAL MACHINES (PART TIME)"> ELECTRICAL MACHINES (PART TIME)</option>
...
<option value="EMBEDDED & REAL TIME SYTEMS ">EMBEDDED & REAL TIME SYTEMS</option>
...
<option value="INDUSTRIAL ENGINEERING ">INDUSTRIAL ENGINEERING</option>
<option value="INDUSTRIAL ENGINEERING (PART TIME) ">INDUSTRIAL ENGINEERING (PART TIME)</option>
<option value="INDUSTRIAL METALLURGY ">INDUSTRIAL METALLURGY</option>
<option value="INDUSTRIAL METALLURGY (PART TIME) ">INDUSTRIAL METALLURGY (PART TIME)</option>
...
<option value="MANUFACTURING ENGINEERING ">MANUFACTURING ENGINEERING</option>
<option value="MANUFACTURING ENGINEERING (PART TIME)"> MANUFACTURING ENGINEERING (PART TIME)</option>
<option value="MECHATRONICS ENGINEERING"> MECHATRONICS ENGINEERING</option>
...
<option value="PRODUCT DESIGN & COMMERCE"> PRODUCT DESIGN & COMMERCE</option>
<option value="PRODUCT DESIGN AND DEVELOPMENT "> PRODUCT DESIGN AND DEVELOPMENT </option>
<option value="SOFTWARE ENGINEERING ">SOFTWARE ENGINEERING</option>
<option value="SOIL MECHANICS & FOUNDATION ENGINEERING"> SOIL MECHANICS & FOUNDATION ENGINEERING</option>
<option value="STRUCTURAL ENGINEERING ">STRUCTURAL ENGINEERING</option>
<option value="STRUCTURAL ENGINEERING (PART TIME) ">STRUCTURAL ENGINEERING (PART TIME)</option>
<option value="THERMAL ENGINEERING ">THERMAL ENGINEERING</option>
<option value="VIRTUAL PROTOTYPING & DIGITAL MANUFACTURING"> VIRTUAL PROTOTYPING & DIGITAL MANUFACTURING</option>
...
<option value="CYBER SECURITY (5 YEAR INTEGRATED) ">CYBER SECURITY (5 YEAR INTEGRATED)</option>
<option value="DATA SCIENCE (5 YEAR INTEGRATED)"> DATA SCIENCE (5 YEAR INTEGRATED)</option>
<option value="DATA SCIENCE (5 YEARS) (SS) DATA"> SCIENCE (5 YEARS) (SS)</option>
<option value="DECISION AND COMPUTING SCIENCES (INTEGRATED)"> DECISION AND COMPUTING SCIENCES (INTEGRATED)</option>
...
<option value="SOFTWARE SYSTEMS (5 YEARS) (SS)"> SOFTWARE SYSTEMS (5 YEARS) (SS)</option>
...
<option value="CHEMICAL ENGINEERING ">CHEMICAL ENGINEERING</option>
<option value="COMPUTER SCIENCE AND ENGINEERING (5 YEAR INTEGRATED)"> COMPUTER SCIENCE AND ENGINEERING (5 YEAR INTEGRATED)</option>
<option value="DATA SCIENCE ">DATA SCIENCE</option>
<option value="ENVIRONMENTAL SCIENCE AND TECHNOLOGY"> ENVIRONMENTAL SCIENCE AND TECHNOLOGY</option>
<option value="FOOD TECHNOLOGY ">FOOD TECHNOLOGY</option>
<option value="INFORMATION TECHNOLOGY"> INFORMATION TECHNOLOGY</option>
<option value="INFORMATION TECHNOLOGY(INFORMATION & CYBER WARFARE) ">INFORMATION TECHNOLOGY(INFORMATION & CYBER WARFARE)</option>
<option value="MASTERS OF TECHNOLOGY MANAGEMENT ">MASTERS OF TECHNOLOGY MANAGEMENT</option>
          ...
          <div class="table-box">
            ...
            <div class="table-row">
              ...
              <script>
                function All()
                {
                  var x = document.getElementById("discontinued_sem").value;
                  document.getElementById("readmission_sougth_sem").value = x;
                }
              </script>
              <div class="table-cell last-cell">
