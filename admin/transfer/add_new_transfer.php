            ...
            var objectN=({}).constructor;
              ...
              else
              {
                ...
                $.each(result, function(key, value) {
                  ...
                  var c_code=getC_code($("#fcollege").val());
                var link = '../../request_transfer/last_semester_marksheet/' + c_code + '_' + $("#reg_no").val() + '.pdf';
  ...
  <body>
    ...
    <div class="mainDiv">
      ...
      <div class="single-div">
        ...
        <div class="single-div">
          <h3 style="margin: 0px auto;text-align: center;">Name of the Institution and branch in which student studied Odd Sem(III,V,VII,IX)</h3>
