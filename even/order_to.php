...
$sql="select  reg_no,name_of_student,b_name,fcollege,request_for from transfer_details where tcollege_c_code=".$_SESSION['c_code']." and status='O'";
          ...
          <table class="table table-striped" style="margin-top:10px;">
            <thead class="thead-light" >
              <tr>
                ...
                <th scope="col" style="width:35%">From College</th>
          ...
          <tbody >
            ...
            <?php while($result=$stmt->fetch_assoc()): ?>
             <tr scope="row">
               ...
               <td width="35%"><?php echo $result['fcollege']; ?></td>
               <td width="10%"><?php echo $result['request_for']; ?></td>
               <td width="15%"><a href="../report_generation/order_to.php?u_id=<?php echo $result['reg_no']; ?>"class='btn btn-success' style="color:white;">Transfer Order</a></td>
