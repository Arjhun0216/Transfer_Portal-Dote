...
if($stmt=$conn->prepare("select  a_no,name,save from student_info where c_code=? and b_code=?  order by name"))
{
...
<div id="<?php echo $row['a_no'] ;?>" class="tabulator-row tabulator-selectable tabular-row-even" role="row" style="padding-left:0px;">
