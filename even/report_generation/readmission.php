...
class PDF extends FPDF{
    ...
    function header(){
        ...
        $this->Cell(0,6,'UG / PG DEGREE COURSES EVEN SEMESTER 2025 -2026',0,1,'C');
        $this->Cell(0,4,'',0,1,'C');
    }
...
$pdf->SetFont("Times",'B',9);
$pdf->Cell(57,10,'College name with full Address','LR',0,'L');
$pdf->SetFont("Times",'',9);
$pdf->MultiCell(133,8,$result['name_of_college'],1);
$pdf->SetFont('Times','B',9);
$x = $pdf->GetX();
$y = $pdf->GetY();
...
$pdf->Cell(20,6,'',0,0);
$pdf->MultiCell(160,6,'Particulars of lack of attendance is even Semester (II, IV, VI, VIII, X) during the period July - December',0,'L');
$pdf->SetFont("Times",'B',12);
...
$x = $pdf->GetX();
$y = $pdf->GetY();
$pdf->MultiCell(110,6,"Mention the even Semester in which the student was put into lack of \n attendance (II, IV, VI, VIII, X)",1,'L');
$pdf->SetXY($x+110,$y);
$pdf->SetFont("Times",'',9);
