...
$x=2;
$date=date("Y-m-d");
$sql="INSERT INTO readmission_details (reg_no, c_code, name_of_college, name_of_student, address1, address2, district, pincode, mobile, email, tnea_reg_no, community, quota, fg, pms, month_of_admission, year_of_admission, mode_of_admission, b_name, discontinued_sem, discontinued_year, readmission_sougth_sem, readmission_sougth_year, reason, lack_attendence_sem, total_periods, total_attended, percentage,freezed,approved,admin_reason) VALUES (?,?,?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?) ON DUPLICATE KEY UPDATE reg_no=?, c_code=?, name_of_college=?, name_of_student=?, address1=?, address2=?, district=?, pincode=?, mobile=?, email=?, tnea_reg_no=?, community=?, quota=?, fg=?, pms=?, month_of_admission=?, year_of_admission=?, mode_of_admission=?, b_name=?, discontinued_sem=?, discontinued_year=?, readmission_sougth_sem=?, readmission_sougth_year=?, reason=?, lack_attendence_sem=?, total_periods=?, total_attended=?, percentage=?,freezed=?,approved=?,admin_reason=?";
if($stmt=$conn->prepare($sql))
{
    $stmt->bind_param("sssssssssssssiissssiiiisiiiiiissssssssssssssiissssiiiisiiiiiis",$_POST['reg_no'],$_POST['college_name'],$row['name_of_college_with_address'],$_POST['name_of_student'],$_POST['address1'],$_POST['address2'],$_POST['district'],$_POST['pincode'],$_POST['mobile'],$_POST['email'],$_POST['tnea_reg_no'],$_POST['community'],$_POST['quota'],$_POST['fg'],$_POST['pms'],$_POST['month_of_admission'],$_POST['year_of_admission'],$_POST['mode_of_admission'],$_POST['b_name'],$_POST['discontinued_sem'],$_POST['discontinued_year'],$_POST['readmission_sougth_sem'],$_POST['readmission_sougth_year'],$_POST['reason'],$_POST['lack_attendence_sem'],$_POST['total_periods'],$_POST['total_attended'],$_POST['percentage'],$x,$_POST['approved'],$_POST['admin_reason'],$_POST['reg_no'],$_POST['college_name'],$row['name_of_college_with_address'],$_POST['name_of_student'],$_POST['address1'],$_POST['address2'],$_POST['district'],$_POST['pincode'],$_POST['mobile'],$_POST['email'],$_POST['tnea_reg_no'],$_POST['community'],$_POST['quota'],$_POST['fg'],$_POST['pms'],$_POST['month_of_admission'],$_POST['year_of_admission'],$_POST['mode_of_admission'],$_POST['b_name'],$_POST['discontinued_sem'],$_POST['discontinued_year'],$_POST['readmission_sougth_sem'],$_POST['readmission_sougth_year'],$_POST['reason'],$_POST['lack_attendence_sem'],$_POST['total_periods'],$_POST['total_attended'],$_POST['percentage'],$x,$_POST['approved'],$_POST['admin_reason']);
    if($stmt->execute())
    {
        //echo "success";
        $sql = "SELECT *  from readmission_details where reg_no='".$_POST['reg_no']."'limit 1";
