...
function closeForm() {
  ...
  function Denied()
      ...
      function Access()
      {
        ...
        {
          if(document.getElementById("code").value == "18725")
          {
      ...
      <div id="order_issue">
        ...
        <div id="re_order_list">
          ...
          <button  id="re_order_list_save_btn" class="btn btn-primary">
            Generate
          </button>
          <!-- <button type="submit" class="btn btn-success">
            Download
        ...
        <label for="re_batch_no">Batch Number</label>
          ...
          <button  id="re_order_issue_save_btn" class="btn btn-success">
            Save
          </button>
        </div>
