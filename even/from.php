...
<body>
          <div >
              <h2 style="text-align: center;">Transfer / Transfer Cum Readmission-2024</h2>
          </div>
          <div class="container" style="width:95%; height:500px; overflow: auto;" >
          <!-- <a href="../request_transfer/add_new_transfer.php" class="btn btn-primary " >Add New</button></a> -->
        <br>
