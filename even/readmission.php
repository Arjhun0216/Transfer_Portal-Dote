...
<body>
          <div >
              <h2 style="text-align: center;">Readmission Even Semester- 2024-2025</h2>
          </div>
          
       
          <div class="container" style="width:95%; height:500px; overflow: auto;">
          <a href="/transfer/even/readmission/readmission_request.php" class="btn btn-primary  ">Add New</a>
          ...
          <tbody >
            ...
            <?php while($result=$stmt->fetch_assoc()): ?>
             <tr>
               ...
               <td><a href="/transfer/even/readmission/readmission_request.php?u_id=<?php echo $result['reg_no']; ?>"class='btn btn-success' style="color:green;">View</a></td>
             </tr>
             <?php endwhile ?>
        </tbody>
          </table>
