...
$sql="select  reg_no,name_of_student,b_name,tcollege_c_code,status,status_reason from transfer_details where fcollege_c_code=".$_SESSION['c_code'];
          ...
          <table class="table table-striped" style="margin-top:10px;">
            <thead class="thead-light" >
              <tr>
                ...
                <th scope="col" style="width:5%">To College</th>
          ...
          <tbody >
            ...
            <?php while($result=$stmt->fetch_assoc()): ?>
             <tr scope="row">
               ...
               <td width="5%"><?php echo $result['tcollege_c_code']; ?></td>
               <td width="10%"><?php if($result['status']=='A') echo "Approved"; else if($result['status']=='R') echo "Not Approved"; else if($result['status']=='P') echo "Pending";else if($result['status']=='O') echo "Order Generated"; else ""; ?></td>
