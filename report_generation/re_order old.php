...
$pdf->SetFont('Arial','B',16);
        ...
        $pdf->MultiCell(175,6,'Technical Education - Engineering Colleges - Transfer of students between Institution B.E / B.Tech / B.Arch Part time (B.E / B.Tech / PG / MBA / MCA / MCA(L.E) / M.E / M.tech / M.Sc and B.Sc) Degree Courses - 2023 - 2024 - Odd semester (III, V, VII, IX) - Orders Issud - reg.',0,'L',FALSE);
        $pdf->Cell(0,4,'',0,1);
        $pdf->Cell(10,6,'Ref : ',0,0,'L');
        $pdf->MultiCell(175,6,'Transfer Applications forwarded by Principals of Engineering Colleges seeking Transfer of students In odd semester',0,'L',FALSE);
        $pdf->Cell(0,8,'****************',0,1,'C');
        
        $pdf->SetFont('Arial','',11);
        $pdf->MultiCell(180,6,'  With reference to the above, transfer is ordered during the odd semester of the year 2023-2024, the details of which are given below.',0,'L',FALSE);
        $pdf->Cell(0,4,'',0,1,'C');
$pdf->SetFont('Arial','',12);
