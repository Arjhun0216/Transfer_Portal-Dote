...
$sql="select reg_no,name_of_student,sem_to,b_name,request_for,fcollege_c_code,tcollege_c_code,attendence_percentage from transfer_details where tcollege_c_code='".$_SESSION['c_code']."' and reg_no='".$_GET['u_id']."' and status='O'";
