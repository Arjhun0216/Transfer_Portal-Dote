...
class PDF extends FPDF{
    ...
    function header(){
        ...
        $this->Cell(0,6,'DEGREE COURSES (ODD SEMESTER) - 2025- 2026',0,1,'C');
    }
...
$pdf->Cell(57,8,'REGISTER NUMBER','LTB',0,'L');
$pdf->SetFont("Times",'',9);
$pdf->Cell(133,8,$result['reg_no'],'LRTB',1,'L');
$pdf->SetFont('Times','B',9);
...
// $pdf->Cell(57,10,'','',0,'L');
// $pdf->SetFont("Times",'',9);
$pdf->Cell(133,8,$result['name_of_student'],'LRTB',1,'L');
...
$pdf->MultiCell(190,8,'NAME OF THE INSTITUTION, BRANCH AND SEMESTER IN WHICH HE / SHE HAS STUDIED ODD SEMESTER (III,V,VII,IX)',1,'C');
...
if($result['request_for']=="READMISSION CUM TRANSFER"){
$x = $pdf->GetX();
$y = $pdf->GetY();
$pdf->SetFont("Times",'B',9);
$pdf->MultiCell(60,5,'ODD SEMESTER IN WHICH STUDENT WAS PUT INTO LACK OF ATTENDENCE(III,V,VII,IX)',1,'L');
$pdf->SetXY($x+60,$y);
$pdf->SetFont("Times",'',9);
...
$pdf->SetFont("Times",'',9);
$pdf->Cell(54,8,$result['board'],'LRTB',0,'L');

$pdf->SetFont("Times",'B',9);
$pdf->Cell(55,8,'COMMUNITY OF STUDENT',1,0,'L');
$pdf->SetFont("Times",'',9);
$pdf->Cell(32,8,$result['community'],'LRTB',1,'L');

$pdf->SetFont("Times",'B',9);
$pdf->Cell(49,8,'MATHS MARK',1,0,'L');
$pdf->SetFont("Times",'',9);
$pdf->Cell(54,8,$result['mark1'],'LRTB',0,'L');

$pdf->SetFont("Times",'B',9);
$pdf->Cell(55,8,'QUOTA',1,0,'L');
$pdf->SetFont("Times",'',9);
$pdf->Cell(32,8,$result['quota'],'LTBR',1,'L');
...
// $pdf->SetFont("Times",'',9);
// $pdf->Cell(32,8,$result['pmg']=='1'?"YES":"NO",'LRTB',0,'L');
