...
$pdf->SetFont('Arial','B',12);
        ...
        $pdf->Cell(40,8,"16233 / J1 / 2025,",0,0,'L');
        $pdf->Cell(35,8,'Dated :',0,0,'R');
        $pdf->Cell(30,8,$dateVal,0,1,'L');
        $pdf->Cell(0,4,'',0,1);
        $pdf->SetFont('Arial','',10);
        $pdf->Cell(10,6,'Sub : ',0,0,'L');
        $pdf->MultiCell(175,6,'Technical Education - Engineering Colleges - Readmission - 2025- 2026 - Odd semester (I,III, V, VII, IX) - Readmission Orders Issued - reg.',0,'L',FALSE);
        $pdf->Cell(0,4,'',0,1);
        ...
        $pdf->Cell(0,4,'',0,1);
        $pdf->Cell(10,6,'',0,0,'L');
        $pdf->MultiCell(175,6,'2)   Readmission Applications forwarded by the Principals of Engineering Colleges seeking Readmission of students In odd semester',0,'L',FALSE);
        // $pdf->Cell(43,6,'2)   Your Letter no. :',0,0,'L');
...
$pdf->Cell(60,20,'Branch / Admitted','LTRB',0,'L');
$pdf->Cell(130,10,$result['b_name']."/",'RT',1,'L');
$pdf->Cell(130,10,$result['mode_of_admission'],'RB',1,'R');
