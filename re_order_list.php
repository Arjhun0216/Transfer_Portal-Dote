...
$sql="select  reg_no,name_of_student,b_name from readmission_details where c_code=".$_SESSION['c_code']." and approved=4";
          ...
          <table class="table table-striped" style="margin-top:10px;">
            <thead class="thead-light" >
              <tr>
                ...
                <th scope="col" style="width:45%">Dept</th>
          ...
          <tbody >
            ...
            <?php while($result=$stmt->fetch_assoc()): ?>
             <tr scope="row">
               ...
               <td width="45%"><?php echo $result['b_name']; ?></td>
               <td width="20%"><a href="../report_generation/re_order.php?u_id=<?php echo $result['reg_no']; ?>"class='btn btn-success' style="color:white;">Readmission Order</a></td>
