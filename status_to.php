          ...
          <tbody >
            ...
            <?php while($result=$stmt->fetch_assoc()): ?>
             <tr scope="row">
               ...
               <td width="10%"><?php if($result['status']=='A') echo "Approved"; else if($result['status']=='R') echo "Not Approved";else if($result['status']=='P') echo "Pending";else if($result['status']=='O') echo "Order Generated"; else echo ""; ?></td>
